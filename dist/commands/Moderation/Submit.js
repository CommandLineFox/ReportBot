...
class Submit extends Command_1.default {
    ...
    async run(event) {
        ...
        try {
            ...
            const guild = await (database === null || database === void 0 ? void 0 : database.guilds.findOne({ id: message.guild.id }));
            ...
            channel = (_b = message.guild) === null || _b === void 0 ? void 0 : _b.channels.cache.get((guild === null || guild === void 0 ? void 0 : guild.config.channels).submitted);
