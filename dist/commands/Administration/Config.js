        ...
        try {
            ...
            switch (sub) {
                case "staff": {
                    ...
                    switch (sub2) {
                        case "add": {
                            const id = await ((_a = event.guild.roles.cache.find(role => role.name === value)) === null || _a === void 0 ? void 0 : _a.id);
                        ...
                        case "remove": {
                            const id = await ((_f = event.guild.roles.cache.find(role => role.name === value)) === null || _f === void 0 ? void 0 : _f.id);
                            if (!id) {
